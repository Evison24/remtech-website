...
const testimonials = [
  ...
  {
    quote: "Working with Remtech Labs felt like a true partnership. Their communication and expertise in blockchain development were invaluable.",
    name: "Emily Carter",
   ...
   {
    quote: "Their React Native team delivered a high-quality mobile app ahead of schedule. Highly recommended for cross-platform development.",
    name: "David Lee",
...
const services = [
  {
    ...
    description: "Bespoke AI solutions designed for speed, precision, and transparency. Custom LLM building, fine-tuning, and optimisation.",
    link: "/services/ai-llm-development",
  },
  {
    title: "Blockchain & Web3",
    description: "Harness decentralised technologies for secure, transparent platforms. Innovative solutions including metaverse, DeFi, and secure wallets.",
    link: "/services/blockchain-web3-development",
  },
  {
    title: "Mobile Development",
    description: "Scalable, high-performance cross-platform & native mobile apps using React Native, Flutter, Swift, and Kotlin.",
    link: "/services/mobile-development",
  },
   {
    title: "Custom Application Development",
    description: "Tailored software solutions to meet unique business needs, enhancing efficiency and driving growth.",
    link: "/services/custom-application-development",
  },
  {
    title: "Intelligent Model Distillation",
    description: "Transform complex AI into agile, efficient models while retaining expertise, perfect for edge computing.",
    link: "/services/intelligent-model-distillation",
  },
  {
    title: "Low-Code AI Platform",
    description: "Accelerate go-to-market strategies with our intuitive low-code AI platform for rapid development.",
    ...
    <div className="space-y-16">
      ...
      <section className="relative text-center py-16 md:py-24 overflow-hidden rounded-lg bg-neutral-950">
        ...
        <div className="relative z-10">
          ...
          <div className="flex flex-col sm:flex-row justify-center items-center gap-4 mb-12">
            <a href="/services" className="inline-flex items-center justify-center whitespace-nowrap rounded-md text-sm font-medium ring-offset-background transition-colors focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 bg-primary text-primary-foreground hover:bg-primary/90 h-10 px-4 py-2">
              Discover Our Solutions
            </a>
             <a href="/contact" className="inline-flex items-center justify-center whitespace-nowrap rounded-md text-sm font-medium ring-offset-background transition-colors focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 border border-input bg-background hover:bg-accent hover:text-accent-foreground h-10 px-4 py-2 text-white hover:text-black">
              Get In Touch
            </a>
          </div>
          <div className="max-w-md mx-auto">
            <p className="text-sm text-neutral-400 mb-2">Stay updated with our latest insights:</p>
            <CTAForm />
          </div>
        </div>
      </section>
      ...
      <section className="py-16">
        ...
        <p className="text-center text-foreground/70 mb-12 max-w-2xl mx-auto">
          Explore our comprehensive suite of services designed to elevate your business through cutting-edge technology.
        </p>
      ...
      <section className="py-16 bg-secondary/50 rounded-lg px-8">
        <h2 className="text-3xl font-bold text-center mb-12">Why Partner with Remtech Labs?</h2>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 text-center">
          <div>
            ...
            <p className="text-foreground/70 text-sm">Streamlined processes aligned with your business objectives for maximum ROI.</p>
          </div>
          <div>
            <div className="text-4xl mb-4">🚀</div>
            <h3 className="text-xl font-semibold mb-2">Accelerated Growth</h3>
            <p className="text-foreground/70 text-sm">Deep expertise tailored to your goals, helping you stay ahead in evolving markets.</p>
          </div>
          <div>
            <div className="text-4xl mb-4">🤝</div>
            <h3 className="text-xl font-semibold mb-2">Enhanced Collaboration</h3>
            <p className="text-foreground/70 text-sm">Continuous engagement and transparent communication throughout the lifecycle.</p>
          </div>
        </div>
      </section>
