        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          ...
          <div>
            ...
            <p className="text-sm text-foreground/60">
              Empowering businesses with breakthrough AI, mobile, and custom application solutions.
            </p>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li><Link href="/contact" className="text-sm text-foreground/60 hover:text-foreground">Contact</Link></li> {/* Assuming a contact page */}
            </ul>
          </div>
          ...
          <div>
            ...
            <p className="text-sm text-foreground/60 mb-2">info@remtechlabs.com</p> {/* Placeholder */}
            <p className="text-sm text-foreground/60">+1 234 567 890</p> {/* Placeholder */}
