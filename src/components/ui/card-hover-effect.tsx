...
export const Card = ({
  ...
  return (
    <div
      className={cn(
        " rounded-2xl h-full w-full p-4 overflow-hidden bg-card border border-transparent dark:border-white/[0.2] group-hover:border-slate-700 relative z-20 transition-shadow duration-300 group-hover:shadow-lg",
        className
      )}
    >
...
export const CardDescription = ({
  ...
  return (
    <p
      className={cn(
        "mt-4 text-card-foreground/80 tracking-wide leading-relaxed text-sm", // Adjusted margin and color
        className
      )}
    >
      {children}
